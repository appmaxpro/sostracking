...
public interface Condition {
    ...
    static Condition mergeOr(List<Condition> conditions) {
        Condition result = null;
        var iterator = conditions.iterator();
        if (iterator.hasNext()) {
            result = iterator.next();
    ...
    static Condition neq(String column, Object value){
        return new Compare(column, "!=", column, value);
    }
    ...
    static Condition in(String column, Object value){
        return new Compare(column, "in", column, value);
    }

    static Condition notIn(String column, Object value){
        return new Compare(column, "not in", column, value);
    }

    static Condition isNull(String column){
        return new Equals(column, null);
    }

    static Condition notNull(String column){
        return new Equals(column, null);
    }
