...
public class Device extends GroupedModel implements Disableable, Schedulable {
    ...
    public static final String WORKING_STATUS_UNKNOWN = "na";
    public static final String WORKING_STATUS_OFF = "off";
    public static final String WORKING_STATUS_ON = "on";
    public static final String WORKING_STATUS_LOADED = "loaded";
    ...
    public String getWorkingStatus() {
        return workStatus != null ? workStatus :
                getDisabled() ? WORKING_STATUS_UNKNOWN : WORKING_STATUS_OFF;
    }

    public void setWorkingStatus(String workStatus) {
        this.workStatus = workStatus != null ? workStatus.trim() : null;
    }
