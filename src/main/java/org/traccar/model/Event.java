...
public class Event extends Message {
    ...
    public static final String TYPE_WORKING_ON = "workingOn";
    public static final String TYPE_WORKING_OFF = "workingOff";

    public static final String TYPE_DEVICE_IN_SERVICE = "inService";
    public static final String TYPE_DEVICE_ORDER_ACCEPTED = "devOrderAccepted";
    public static final String TYPE_DEVICE_ORDER_REJECTED = "devOrderAccepted";
    public static final String TYPE_DEVICE_ORDER_CANCEL = "devOrderAccepted";
