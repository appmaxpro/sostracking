...
public class PrimitiveIntHashSet extends AbstractIntHopScotchCollection<Object> implements PrimitiveIntSet
{
    ...
    {
        return HopScotchHashingAlgorithm.put( table, monitor, HopScotchHashingAlgorithm.DEFAULT_HASHING, value, valueMarker, this ) == null;
    }
    ...
    public boolean addAll( PrimitiveIntIterator values )
    {
        ...
        {
            changed |= HopScotchHashingAlgorithm.put( table, monitor, HopScotchHashingAlgorithm.DEFAULT_HASHING, values.next(),
    ...
    {
        return HopScotchHashingAlgorithm.get( table, monitor, HopScotchHashingAlgorithm.DEFAULT_HASHING, value ) == valueMarker;
    }
    ...
    {
        return HopScotchHashingAlgorithm.remove( table, monitor, HopScotchHashingAlgorithm.DEFAULT_HASHING, value ) == valueMarker;
    }
    ...
    private static class HashCodeComputer implements PrimitiveIntVisitor<RuntimeException>
    {
        ...
        {
            hash += HopScotchHashingAlgorithm.DEFAULT_HASHING.hashSingleValueToInt( value );
            return false;
        }
